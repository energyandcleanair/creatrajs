...
dir_results <- function(){"results"}
dir_hysplit_output <- function(){here::here("hysplit_output")}
dir_hysplit_met <- function(){Sys.getenv("DIR_HYSPLIT_MET", here::here("hysplit_met"))}

trajs.bucket <- function(){
